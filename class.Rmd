...
ggplot(data = x, mapping = aes(x = mean_age)) +
  geom_histogram(bins = 30, color = "white") + xlim(23,55) + 
  labs(title = "Mean Voting Age in Kenya by Block",
       y = "Count",
       x = "Age")
```
...
```{r}
ggplot(data = x, mapping = aes(x = reg_inc)) +
  geom_histogram(bins = 30, color = "white") + 
  labs(title = "Registered Voters in Kenya by Block",
       y = "Count",
       x = "Age")
```
